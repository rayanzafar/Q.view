...
// والمشتريات، والمعتمِد، والخارجي.
//
// و«مدير تطوير الأعمال» خرج من هذه القائمة **بتغيّر منحه لا بتليين الحارس**: نال «قراءة موظف
// @قطاع» بقرارٍ صريح (كان يسكّن الناس على فرصه ولا يرى كشفهم — انظر matrix.js)، والقاعدة هنا
// كما هي حرفاً: من يملك قراءة الموظف يدخل. والفحص الثاني أدناه — «البوابة لا تضيق عن خدمتها
// ولا تتسع» — لم يتحرّك فيه شيء، وهو الحارس الحقيقي: لو انفتحت الشاشة لدورٍ لا تفتح له الخدمة
// لسقط. أي أن التغيير مرّ من باب المنح، وهو الباب الذي يُراجَع فيه مثله.
//
...
test('من لا يملك قراءة الموظفين يبقى خارج الشاشة — المواءمة لم تفتح باباً جديداً', () => {
  for (const role of ['project_manager', 'consultant', 'employee',
