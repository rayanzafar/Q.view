...
// ── الرمز لا يُكتب في العنوان أبداً ──
// كان العنوان «رمز الدخول إلى سند: ١٢٣٤٥٦». والعنوان يُعرض في **قائمة** الرسائل وفي إشعار
// الشاشة المقفلة وفي لوحة مزوّد البريد — أي أن الرمز الحيّ يُقرأ بلا فتح أي رسالة، ومن أي
// شاشةٍ تمرّ عليها عينٌ عابرة. وبما أن الرمز هو وسيلة الدخول **الوحيدة** بعد إطفاء كلمة
// المرور، فقراءته دخولٌ بحساب صاحبه. رُئي فعلاً في قائمة الرسائل أثناء تشغيل القناة.
//
// العنوان يقول **ماذا** وصل ولا يحمل السرّ؛ والسرّ في المتن حيث يلزم فتحُ الرسالة لقراءته.
// وهذا هو سلوك كل مزوّد هوية جادّ، لا احتياطٌ زائد.
export function signInCodeMail({ code, minutes }) {
  return {
    subject: 'رمز الدخول إلى سند',
    html: shell({
      title: 'رمز الدخول',
...
export function inviteCodeMail({ code, minutes, inviterName }) {
  return {
    // العنوان بلا رمز — للسبب نفسه المشروح أعلاه. ورمز التفعيل أخطر: به يُفتح الحساب أول مرة.
    subject: 'رمز تفعيل حسابك في سند',
    html: shell({
      title: 'تفعيل حسابك',
      lead: inviterName
