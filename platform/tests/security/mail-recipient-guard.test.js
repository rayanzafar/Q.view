...
test('العنوان المسموح يَعبُر الحارس ويصل إلى قناة الإرسال', async () => {
  await assert.rejects(
    ...
    // الصياغة تسمّي القناة («الأصلية») منذ صارت للمنصة قناتان — والمرفوع خطأ الأصلية عمداً
    // حتى لو جُرّبت الاحتياطية بعدها، فهي التي تحتاج إصلاحاً.
    /قناة البريد الأصلية غير مفعّلة/,
  );
});
