...
الحالة: الدفعة الأولى قيد التحقق محليًا، غير منشورة. الأساس: `1efbea3`، 2026-09-05.
...
| GitHub | مرجع الكود والقرارات وطلبات التغيير وCI | القراءة متاحة؛ رفع v5.75 رفضته مراجعة الموافقة الآلية حتى اعتماد الوجهة والحزمة صراحة؛ الإضافة غير متحققة |
| Railway | تشغيل النسخة المقبولة والسجلات والنسخ الاحتياطي | مسار الإصدار الوحيد في DEPLOY-PIPELINE؛ لا تغيير لقناة النشر الحالية |
