...
// لا مسارَي رفع/تنزيل — بقرار المالك (2026-08-11): «خلّيه بالرابط أفضل، ما أبغى أحفظ ملفات
// حالياً في المنصة». القدرة كاملة (uploadOpportunityFile/readOpportunityFileForDownload +
// جدول document_blob) خاملة في oppdocs.js بحُرّاسها واختباراتها — إن عاد القرار تُعاد
// المسارات وحدها.
