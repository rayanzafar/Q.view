...
export const ROLE_GRANTS = {
  ...
  // يُسترجَع. («المدير المباشر» أدناه بقي على النطاق «إدارة» كما كُتب هنا؛ ومدير الإدارة اتّسع
  // إلى القطاع في **الأرقام وحدها** بقرار مالك لاحق، مشروحٌ في الفقرة التالية.)
  // ── ومركز القطاع بأرقامه: قرار مالك صريح ──────────────────────────────────────
  ...
  // كلفة — فيدخل من دُعي إليه ليجد شاشةً ناقصة تُخفي عنه ما بُني له. مديرُ إدارةٍ يخطّط عمل
  // فريقه على ربح القطاع ومستهدفه، فإخفاؤهما يجعله يخطّط بلا رقم.
  //   • `report`/`kpi` بنطاق **قطاع**: اتساع يبلغ عدسة القطاع في محرك التقارير ويفتح مركز
  //     قيادته — الإيراد والمبيعات والمستهدفات وخط الفرص.
  //   • `margin`/`cost` بنطاق **قطاع**: الربح والكلفة يصلانه فعلاً بدل أرقام محجوبة.
  //   • قراءة **الناس والعمل** تبقى بنطاق «إدارة» حرفاً بحرف: يقرأ رقم القطاع ولا يقرأ ملفات
  //     أهله ولا مهامهم. الاتساع في الأرقام لا في الأشخاص.
  //   • و**لا راتب بأي شكل**: الراتب مختوم لمدير النظام وحده حتى تكامل Odoo (قرار مالك سابق)،
  //     ولا لوحة قيادة شركة: `seesCompanyPerformance` تشترط اتساعاً شركياً — والفحص يحرسهما.
  department_manager: [
