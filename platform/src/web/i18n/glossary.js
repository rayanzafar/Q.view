...
// «مركز التطوير»: الكلمات العربية لقيمه المخزَّنة مكتوبةٌ مرةً واحدة في وحدته
// (`src/modules/products/labels.js`) لأن البريد وردود المساعد يقرآنها كما تقرؤها الشاشة —
// والمعجم يعيد تصديرها بأسمائه لا ينسخها، فلا تفترق نسختان أبداً.
import {
  ITEM_STATUS, ITEM_TYPE, ITEM_URGENCY, ITEM_SIZE, ITEM_PRIORITY, ITEM_SOURCE,
  MEMBER_ROLE, PRODUCT_KIND, IDENTITY_MODE, IMAGE_KIND,
  itemStatusLabel, itemTypeLabel, itemUrgencyLabel, itemSizeLabel, itemPriorityLabel,
  itemSourceLabel, memberRoleLabel, productKindLabel,
...
export const G = {
  ...
  // ── عدسة الفترة ومرشِّح المشروع (مركز القطاع) ──
  // «من بداية السنة» لا «حتى تاريخه»: الثانية تُقرأ تاريخاً بعينه لا مدى. و«مدى الأشهر»
  // مُنتقيان اثنان يعملان بلا نصٍّ برمجي — النموذج يرسل الشهرين والصفحة تركّبهما فترةً واحدة.
  ytd: 'من بداية السنة',
  monthRange: 'مدى الأشهر',
  fromMonth: 'من شهر',
  toMonth: 'إلى شهر',
  showRange: 'اعرض المدى',
  // قاعدةُ المدى تُقال في سطرٍ واحد تحت الرقائق بدل أن يكتشفها القارئ بالمحاولة: نقرةٌ
  // تختار فترةً، ونقرةٌ ثانية على فترةٍ من جنسها تحدّد المدى بينهما.
  periodRangeHint: 'اختر فترةً، ثم ثانيةً لتحديد مدى بينهما',
  // انتماءُ رقاقةٍ إلى المدى المختار يُقال بلسانها لا بلونها وحده — الشريط واللون لا يبلغان
  // من يقرأ بقارئ الشاشة، فتُلحَق هذه الجملة بتلميح كل رقاقةٍ داخل المدى، طرفاً كانت أو وسطاً.
  withinSelectedRange: 'ضمن المدى المختار',
  allProjects: 'كل المشاريع',
  wholeSector: 'القطاع كله',
  ...
  // ── مركز التطوير ──────────────────────────────────────────────────────────
  // الكلمات هنا، والقيم المخزَّنة تُترجَم بخرائط الوحدة المعادِ تصديرها أسفل هذا الكائن.
  devCenter: 'مركز التطوير',
  devCenterSubtitle: 'بلاغات المنتجات ومقترحاتها من وصولها حتى حلّها',
  devCenterLead: 'المنتجات التي تعمل عليها',
  products: 'المنتجات',
  product: 'المنتج',
  newProduct: 'منتج جديد',
  productTeam: 'فريق المنتج',
  devRole: 'مطوِّر',
  managerRole: 'مدير المنتج',
  myRoleHere: 'دورك هنا',
  tenant: 'الجهة',
  tenants: 'الجهات',
  newTenant: 'جهة جديدة',
  noTenantsYet: 'لا جهات بعد',
  externalTenant: 'جهة خارجية',
  internalUse: 'استخدام داخلي (EVC)',
  publicLink: 'رابط الاستقبال',
  publicLinks: 'روابط الاستقبال',
  newLink: 'رابط جديد',
  ...
  visits: 'زيارات',
  submissions: 'بلاغات',
  distinctReporters: 'مُبلِّغون',
  reportIssue: 'أبلغ',
  addOnBehalf: 'سجّل عن غيرك',
  issue: 'عُطل',
  suggestion: 'اقتراح',
  items: 'العناصر',
  itemNo: 'رقم',
  ...
  itemTitle: 'العنوان',
  reporter: 'المُبلِّغ',
  reporterAndSector: 'المُبلِّغ والقطاع',
  whereHappened: 'أين حدث',
  urgency: 'الإلحاح',
  urgencyBlocks: 'يعطّل عملي',
  urgencyDelays: 'يؤخّر عملي',
  urgencyImprove: 'تحسين لا يعطّل',
  itemNew: 'جديد',
  itemTriaged: 'قيد الدراسة',
  itemAwaitingApproval: 'بانتظار الاعتماد',
  itemApproved: 'معتمد',
  itemDeclined: 'مرفوض',
  itemInProgress: 'قيد التنفيذ',
  itemResolved: 'تم الحل',
  itemNeedsInfo: 'بحاجة لتوضيح',
  itemDuplicate: 'مكرر',
  sizeS: 'صغير',
  sizeM: 'متوسط',
  sizeL: 'كبير',
  estHours: 'الساعات المقدَّرة',
  devNote: 'ملاحظة المطوِّر',
  beforeWord: 'قبل',
  afterWord: 'بعد',
  versionTag: 'الإصدار',
  versions: 'الإصدارات',
  newVersion: 'إصدار جديد',
  noVersionsYet: 'لا إصدارات بعد',
  notReleasedYet: 'لم يُطلق بعد',
  declineReason: 'سبب الرفض',
  declineReachesReporter: 'سبب الرفض يصل إلى من أبلغ',
  assignTo: 'أسنِد إلى',
  awaitingYourApproval: 'بانتظار اعتمادك',
  awaitingApprovalShort: 'بانتظار الاعتماد',
  itemResolvedShort: 'تم حلّها',
  itemDeclinedShort: 'مرفوضة',
  itemsOpen: 'مفتوحة',
  itemsTotal: 'الإجمالي',
  avgDaysToResolve: 'متوسط أيام الحل',
  byStatus: 'التوزيع على الحالات',
  reportsTab: 'التقارير',
  reportLead: 'ملخّص ما وصل ضمن المرشِّحات المختارة',
  openPrintable: 'افتح صفحة الطباعة',
  printNow: 'اطبع',
  backToScreen: 'العودة إلى الشاشة',
  preparedBy: 'أعدّه',
  appliedFilters: 'المرشِّحات',
  noFilters: 'بلا مرشِّحات — كل ما وصل',
  noItemsInRange: 'لا عناصر ضمن هذه المرشِّحات',
  addMember: 'أضف عضواً',
  noMembersYet: 'لا أعضاء بعد',
  remove: 'إزالة',
  branding: 'هوية المنتج',
  brandColor: 'لون المنتج',
  brandingHint: 'اللون يظهر على بطاقة المنتج وفي بريد بلاغاته داخل إطار الشركة.',
  settings: 'الإعدادات',
  apply: 'طبّق',
  ...
  toDate: 'إلى تاريخ',
  searchWord: 'بحث',
  searchInItems: 'ابحث في العناوين والأرقام',
  statusWord: 'الحال',
  ageWord: 'العمر',
  noTitle: 'بلا عنوان',
  notSet: 'غير محدد',
  noDescription: 'بلا وصف',
  noProductsYet: 'لا منتجات بعد',
  noProductsAdminHint: 'أنشئ أول منتج، ثم عيّن له مدير منتج وفريقاً يستقبل بلاغاته.',
  noProductsMemberHint: 'لم تُضَف إلى فريق أي منتج بعد — يضيفك مدير المنتج أو مدير النظام.',
  noItemsHere: 'لا عناصر ضمن هذا الاختيار',
  noItemsHint: 'وسّع المرشِّحات أو امسحها لترى بقية ما وصل.',
  listTruncated: 'عُرضت أحدث العناصر فقط — ضيّق المدى الزمني لترى الأقدم.',
  sincePrefix: 'منذ',
  sinceOneDay: 'منذ يوم واحد',
  sinceTwoDays: 'منذ يومين',
  daysPlural: 'أيام',
  daySingularCounted: 'يوماً',
  viaAgent: 'عبر',

  // ── قائمة الدخل للقطاع (الشاشة، وملفّ Excel، وورقة الطباعة) ──────────────────
  // «لم يُسجَّل» لا «صفر»: الصفر ادّعاءُ علمٍ بأن الكلفة معدومة، والفراغ اعترافٌ بأنها لم تُدخَل.
  incomeStatement: 'قائمة الدخل',
  lineItem: 'البند',
  englishTerm: 'المصطلح بالإنجليزية',
  fyPlan: 'خطة السنة',
  periodPlan: 'خطة الفترة',
  periodActual: 'الفعلي',
  grossProfitPct: 'نسبة مجمل الربح',
  notEnteredYet: 'لم يُسجَّل',
  periodWord: 'الفترة',
  fullYear: 'السنة كاملة',
  departmentWord: 'الإدارة',
  withoutDepartment: 'بلا إدارة',
  downloadExcel: 'تنزيل Excel',
  printCopy: 'نسخة للطباعة',
  revenueVsSalesExplain: 'الإيراد ما تحقق من عمل مُنجَز، والمبيعات ما فاز به القطاع من عقود — رقمان مختلفان.',
  planIsSectorWide: 'الخطة على مستوى القطاع كله، لا على ما اختير منه.',
  costsAreSectorWide: 'بنود التكلفة تُقفل على مستوى القطاع كله، فلا تظهر لما اختير منه.',
  noMonthlyPlanNote: 'لا توزيع شهري معتمد للمستهدف، فخطة الفترة تبقى فارغة.',
  noTargetRecordedNote: 'لا مستهدف مسجَّل لهذا القطاع في هذه السنة.',
  // قاعدةُ حالة المشروع بجملةٍ واحدة: الشاشة تقولها في موضعين (لوحة المشروع ولوحة المشاريع)،
  // وكانت مكتوبةً بصياغتين تختلفان في «لا تُحتسب هنا» و«لا تُحتسب من الأرقام هنا» — فالقارئ
  // يظنّهما قاعدتين. تُقرأ مسبوقةً بكلمة «الحالة» أو باسم الحالة نفسه.
  ragOwnerNote: 'كما يحدّدها مدير المشروع في صفحة المشروع، ولا تُحتسب من الأرقام هنا',
  // شريطٌ واحد فوق كتلة الكلفة حين تخلو كلُّها — بدل تسعِ خلايا تقول «لم يُسجَّل» تسع مرات.
  // وبالفعل نفسه الذي في الخلايا (`notEnteredYet` = «لم يُسجَّل»): شريطٌ يقول «لم تُدخل» فوق
  // خلايا تقول «لم يُسجَّل» يوهم القارئ بحالتين اثنتين، وهما حالةٌ واحدة.
  costsNotEnteredYet: 'لم تُسجَّل تكاليف القطاع بعد — سطر الإيراد فقط متاح الآن.',
  amountsInSarCostsBracketed: 'بالريال السعودي · الأرقام بين قوسين تكاليف',

  // خرائط القيم المخزَّنة كما تصلنا من وحدة المنتجات — لا نسخة ثانية من نصّها هنا.
  itemStatusAr: ITEM_STATUS,
  itemTypeAr: ITEM_TYPE,
  itemUrgencyAr: ITEM_URGENCY,
  itemSizeAr: ITEM_SIZE,
  itemPriorityAr: ITEM_PRIORITY,
  itemSourceAr: ITEM_SOURCE,
  productRoleAr: MEMBER_ROLE,
  productKindAr: PRODUCT_KIND,
  identityModeAr: IDENTITY_MODE,
  imageKindAr: IMAGE_KIND,
};
...
// ── خرائط «مركز التطوير» معادةَ التصدير بأسماء المعجم ────────────────────────
// المصدر واحد: `src/modules/products/labels.js` — والوحدةُ والبريد يقرآن منه مباشرة،
// والشاشات تقرأ من المعجم (`G.itemStatusAr`)، والنصّ العربي مكتوبٌ مرةً واحدة لا مرتين.
export {
  ITEM_STATUS, ITEM_TYPE, ITEM_URGENCY, ITEM_SIZE, ITEM_PRIORITY, ITEM_SOURCE,
  MEMBER_ROLE, PRODUCT_KIND, IDENTITY_MODE, IMAGE_KIND,
  itemStatusLabel, itemTypeLabel, itemUrgencyLabel, itemSizeLabel, itemPriorityLabel,
