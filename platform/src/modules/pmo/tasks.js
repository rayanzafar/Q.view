...
// (`approvedTaskSql` وأخواته). أُنزل إليه كي يبلغه مقياسُ «نسبة الإشغال» بلا دورةِ استيراد،
...
export async function teamWorkload(user, filters = {}) {
  ...
  // وعمودا «نسبة الإشغال» يركبان هذا التجميع نفسه: شرطُه (مفتوحة · معتمدة · غير شخصية) هو
