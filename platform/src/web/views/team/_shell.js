...
export const PATHS = Object.freeze({
  people: { key: 'people', label: G.pathPeople, href: '/app/team/resources', icon: 'team',
    blurb: 'استعرض موارد فريقك ومهاراتهم وقدراتهم من داخليين، خارجيين وشركاء.' },
  planning: { key: 'planning', label: G.pathPlanning, href: '/app/team/planning', icon: 'clock',
    blurb: 'خطّط واستعرض تخصيص الموارد عبر المشاريع والمنتجات والتطوير والأعمال الداخلية بمرور الوقت.' },
  work: { key: 'work', label: G.pathWork, href: '/app/team/work', icon: 'tasks',
    blurb: 'نظرة الفريق عبر المهام والمشاريع والمنتجات والفرص دون التكرار.' },
  analysis: { key: 'analysis', label: G.pathAnalysis, href: '/app/team/analysis', icon: 'trend',
    blurb: 'حلل الاستغلال وأعباء العمل وحالة التغطية واحتياجات الموارد المستقبلية.' },
});
