...
const FLAG = 'op:utilization-may-2026-v8';
const YEAR = 2026;
...
// وأداة التعريف تُنزَع عن اسم العائلة: الكشف يكتب «هادي احمد الكرمي» والمنصة «هادي كرمي»،
// فـ«الكرمي» و«كرمي» كلمتان مختلفتان في المقارنة وهما اسمٌ واحد — وهذا وحده أسقط مطابقته بعد
// أن صحّ كل شيء آخر. والنزع مشروطٌ ببقاء ثلاثة أحرف فأكثر كي لا يُمسَخ اسمٌ قصير.
const stripAlName = (w) => (w.length >= 5 && /^ال/.test(w) ? w.slice(2) : w);
