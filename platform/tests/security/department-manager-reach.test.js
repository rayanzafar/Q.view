...
// قرار المالك (٢٠٢٦-٠٨) قلب النصف الثاني: فرصةُ إدارةٍ أخرى في قطاعه كانت تُقرأ (لأن قائمته
// كانت قطاعية فلحق بها الصفّ عبر SECTOR_WIDE_LISTS)، وصارت لا تُقرأ — القائمة ضاقت إلى
// إدارته، والمُوسِّع القديم أُزيل معها وإلا صار هو التسريب. والتفصيل كله في
// tests/security/opportunity-visibility.test.js — وهنا يثبَّت الحدُّ في نفس الملف الذي يحرس بقية حدوده.
test('وفرصةُ إدارةٍ أخرى في قطاعه لم تعد تُقرأ — الرؤية انقلبت من القطاع إلى الإدارة', () => {
  assert.equal(can(DM, 'read', 'opportunity', inSector), false,
    'المُوسِّع القطاعي القديم ما زال يفتح فرص الإدارات الأخرى');
});
