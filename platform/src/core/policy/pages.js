...
export const PAGE_ACCESS = {
  ...
  'assistant-link': () => true,
  // وتغييراتُ مساعده المنتظِرة كذلك: الصفحة تعرض ما طلبه مساعدُ **حسابه هو** ولا شيء غيره،
  // والأداةُ التي تُنفَّذ بعد ضغطته تفحص صلاحيتها بنفسها كما لو نادى الأداةَ مباشرة. فبوابةُ
  // الصفحة هنا لا تمنح شيئاً، ووضعُ منحٍ عليها يمنع الموظف من ردّ تغييرٍ طُلب باسمه هو.
  'ai-changes': () => true,
  ...
  // إعدادات لوحة الفرص: شاشةُ **تعديل** لا قراءة — من يفتحها يعيد تسمية الأعمدة ويرتّبها
  // ويحذفها. فبوابتها منح إدارة اللوحات نفسه الذي تفحصه الخدمة عند كل كتابة (`crm_board`)،
  // لا منح قراءة الفرص: عرضُ الشاشة لمن لا يملك تغيير حرفٍ فيها وعدٌ بأزرارٍ يردّها الخادم.
  'crm-board-settings': (u) => can(u, 'update', 'crm_board'),
