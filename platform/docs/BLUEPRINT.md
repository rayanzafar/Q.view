...
الحالة: v5.75–v5.80 منشورة على staging ومتحقَّق منها حياً (2026-09-06؛ v5.79 عند `45a28d4`، v5.80 عند `184a19c`)، وv5.81 (ربط المساعد الذكي) منفَّذة محلياً بانتظار النشر. الأساس السابق: `1efbea3`، 2026-09-05.
...
- **v5.81 (ربط المساعد الذكي):** خادم MCP داخل سند بمصادقة OAuth 2.1 مربوطة بحساب الموظف نفسه، وصفحة «ربط المساعد» وشاشة إذنٍ عربية، وثلاث أدوات تعرّف المساعد بالمنصة من خدمة الدليل. أُغلق KI-097. الحدّ المعلن: الخادم منفَّذ ومختبَر عندنا، وتجربة عميلٍ خارجي حقيقي تُوثَّق بنتيجتها حين تجري.
