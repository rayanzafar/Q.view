...
test('الجسر المالي و«فترة التحصيل» يقرآن الإيراد نفسه لنفس القارئ', async () => {
  ...
  // الإيراد صافٍ بعد ٠١٩: ١٬٢٠٠٬٠٠٠ هللة إجمالاً ⟵ ١٬٠٤٣٬٤٧٨ صافياً.
  assert.equal(s.revenue_halalas, 1_043_478, 'إيراد القطاع وحده في الجسر، بلا الضريبة');
  assert.equal(s.revenue_gross_halalas, 1_200_000, 'وإجماليه من القطاع نفسه لا من الشركة كلها');
  assert.equal(s.ar_halalas, 600_000, 'المستحق إجمالي — العميل مدينٌ بالضريبة كما هو مدينٌ بالأصل');
  // وفترة التحصيل تقسم مستحقاً إجمالياً على إيرادٍ إجمالي: طرفان من عالمٍ واحد، نطاقاً وأساساً.
