...
//   • S17 يعرض التغطية «غير متاحة» دائماً (C8) ونسبة الإشغال من المهام «غير مقاسة» لمن بلا نسب، وقالب
...
test('S18: الأدلة والأسئلة ونموذج المتابعة والسطر الصريح والروابط بسياق الفترة', async () => {
  ...
  assert.ok(html.includes('التسكين المؤكد') && html.includes('نسبة الإشغال من المهام') && html.includes('مصفوفة التسكين'), 'أدلة بلا مصادر');
